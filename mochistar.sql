...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-01-2026 a las 19:05:05
...
INSERT INTO `producto` (`id_producto`, `imagen`, `cantidad`, `descripcion`, `nombre`, `precio_unidad`, `id_oferta`) VALUES
(3, 'mochiCaja.webp', 10, 'Ideal para senderismo y viajes de fin de semana. Resistente al agua y con múltiples correas de ajuste.', 'Pack de 16', 75.50, NULL),
(6, 'mochis.webp', 100, 'Mochi basico', 'Mochi basico', 45.50, NULL),
(7, 'mochiLigaPersona.webp', 50, 'Mochi de LaLiga', 'Mochi LaLiga', 19.95, NULL);
...
(1, 'Usuario Prueba', 'Apellido', 'prueba@gmail.com', '', 'cliente', '$2y$10$uL7MSOWEfjtRxA3E9NRUCOK.PR1sJGHOyTu8cupsPh1rjyTdB158.'),
...
CREATE TABLE `logs` (
  ...
  CONSTRAINT `fk_logs_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
